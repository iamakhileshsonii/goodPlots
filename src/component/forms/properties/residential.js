...
const ResidentialForm = () => {
  ...
  async function createResidentialProperty(event) {
    event.preventDefault();
    const formData = {
      title: event.target.residential_propertyTitle.value,
      desc: event.target.residential_propertyDesc.value,
      author: {
    ...
    <>
      <div className="grid justify-center py-20">
        <Card
          color="transparent"
          shadow={false}
          className="border border-bordercolor p-10"
        >
          <Typography
            variant="h4"
            color="blue-gray"
          ...
          <form
            ...
            onSubmit={createResidentialProperty}
          >
            <div className="mb-1 flex flex-col gap-6">
              ...
              <Input
                ...
                className=" !border-t-blue-gray-200 focus:!border-t-gray-900 residential_propertyTitle"
                name="residential_propertyTitle"
                labelProps={{
              ...
              <div
                className="flex gap-10 ali"
                name="residential_propertyPossesionStatues"
              >
              ...
              <div className="flex">
                <Typography
                  variant="h6"
                  color="blue-gray"
                  className="-mb-3 text-xs font-normal"
                >
              ...
              <Typography
                ...
                className="-mb-3 text-xs font-normal"
              >
                Possession with tenant (not in dispute).
              </Typography>
              <div className="flex gap-10">
              ...
              <div className="block">
                <Typography variant="h6" color="blue-gray" className="-mb-3">
                  TITLE (check whichever is applicable)
                </Typography>
                <Checkbox id="ripple-on" label="Clear Title" ripple={true} />
                <Checkbox
                  id="ripple-on"
                  label="Title currently under dispute with restriction on sale"
                  ripple={true}
                />
                <Checkbox
                  id="ripple-on"
                  label="Title currently under dispute with NO restriction on sale"
                  ripple={true}
                />
                <Checkbox
                  id="ripple-on"
                  label="Title previously under dispute but now clear with no restrictions"
                  ripple={true}
                />
              </div>
