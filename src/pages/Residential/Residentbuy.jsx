  ...
  return (
    <div className='grid justify-center py-20 px-40 border-bordercolor'>
      ...
      <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96" onSubmit={handleSubmit_residentialBuy}>
        ...
        <div className='w-96'>
            <select name="residentialBuy_Subtype" placeholder="Select Subtype" onChange={(e)=> handle_SubType(e.target.value)} className='p-4 border border-bordercolor rounded w-96'>
